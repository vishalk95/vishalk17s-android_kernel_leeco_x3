...
#define FG_METER_RESISTANCE 	53

/*[---Start add by Rachel, support 2nd battery,20141208---]*/
/* Qmax for battery  */
#define Q_MAX_POS_50 2954
#define Q_MAX_POS_25 2999
#define Q_MAX_POS_0 1926
#define Q_MAX_NEG_10 990

#define Q_MAX_POS_50_H_CURRENT 2895
#define Q_MAX_POS_25_H_CURRENT 2939
#define Q_MAX_POS_0_H_CURRENT 1887
#define Q_MAX_NEG_10_H_CURRENT 970


#define MTK_MULTI_BAT_PROFILE_SUPPORT		//dual bat
#define MTK_GET_BATTERY_ID_BY_AUXADC		//ADC battery ID

#define BATTERY_ID_CHANNEL_NUM		7		//ADC channel
#define TOTAL_BATTERY_NUMBER		2		//battery number
...
/* fg 2.0 */
#define DIFFERENCE_HWOCV_RTC		100//30
#define DIFFERENCE_HWOCV_SWOCV		100  //letv use the rtc value when boot
