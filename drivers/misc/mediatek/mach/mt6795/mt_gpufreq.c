...
/* want to disable the GPU touch boost. 
 * so we don't register the input handler, also don't create the input boost task. 
...
{
/* the task won't be created, and the imput handler also won't be registered. 
	#ifdef MT_GPUFREQ_INPUT_BOOST
