...
#define CUST_EINT_SWITCH_MUTE_NUM              175
#define CUST_EINT_SWITCH_MUTE_DEBOUNCE_CN      0
#define CUST_EINT_SWITCH_MUTE_TYPE							CUST_EINTF_TRIGGER_FALLING
#define CUST_EINT_SWITCH_MUTE_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
