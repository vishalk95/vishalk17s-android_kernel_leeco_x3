...
#define SYS_ATTR_NAME_DEVICE_ID			device_id
...
ssize_t show_device_id(struct device *dev, struct device_attribute *attr, char *buf)
{
	return scnprintf(buf, PAGE_SIZE, "device id :0x%x",chip_device_id);
}
...
struct device_attribute driver_attribs[] = {
	...
	__ATTR(SYS_ATTR_NAME_DEVICE_ID	,0444,show_device_id		, NULL),
	__ATTR_NULL
};
