...
#ifdef	USE_VH_SYNC
	RegWriteA( STROBEFC,	0x80 ) ;				// 0x001C	
...
void	IniGyr( void )
{
	...
	RegWriteA( WG_LMT3MOD , 0x00 );						// 0x0118 	[ - | - | - | - ][ - | - | - | CmLmt3Mod ]
														//				CmLmt3Mod	0: 
	RegWriteA( WG_VREFADD , 0x12 );						// 0x0119	 	@(default 0x12 = GXH1Z2/GYH1Z2)
#endif
	...
	RamWrite32A( gylmt4HS0, GYRLMT4_S1 ) ;				// 0x112B	YLimiter4 High臒l0
	RamWrite32A( gxlmt4HS0, GYRLMT4_S1 ) ;				// 0x102B	XLimiter4 High臒l0
	
	RamWrite32A( gxlmt4HS1, GYRLMT4_S2 ) ;				// 0x102C	XLimiter4 High臒l1
	RamWrite32A( gylmt4HS1, GYRLMT4_S2 ) ;				// 0x112C	YLimiter4 High臒l1
...
#ifdef	NEW_PTST
	UnGyrLmt.SfFltVal	= 0.003F ;						// St4 Limiter
...
void	ClrGyr( unsigned short UsClrFil , unsigned char UcClrMod )
{
	...
	/*Enable Clear*/
	RegWriteA( WC_RAMINITON	, UcClrMod ) ;	// 0x0102	[ - | - | - | - ][ - | - | Clr ]
