...
extern void read_s5k3l8_static_otp();
extern kal_bool BU6429_Alive(void);

extern int Main_Camera_MID;// 

extern int BU6429AF_Init_Thread(void *unused);
extern struct task_struct  *Ofilm_bu6429af_init_thread;
extern int g_s4BU6429AF_Inited;
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x0000) << 8) | read_cmos_sensor(0x0001));
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(BU6429_Alive() == TRUE)
				{
					read_s5k3l8_static_otp();
					Main_Camera_MID = 7;// 7:ofilm 
					LOG_INF("3L8 OFILM MODULE\n");	
					return ERROR_NONE;
				}
				else
				{
					LOG_INF("3L8 NOT OFILM MODULE\n");	
...
static kal_uint32 open(void)
{
	...
	Ofilm_bu6429af_init_thread= kthread_run(BU6429AF_Init_Thread, 0, "BU6429AF_Init"); 
...
extern bool read_3l8_pdaf_data( kal_uint16 addr, BYTE* data, kal_uint32 size);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_GET_PDAF_DATA:
			read_3l8_pdaf_data((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;
