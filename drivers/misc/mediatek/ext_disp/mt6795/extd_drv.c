...
*/
        ...
        case MTK_HDMI_GET_DEV_INFO:
        {
            ...
            else if (hdmi_params->cabletype == MHL_CABLE)
            {
                ...
                HDMI_LOG("mhl --- hdmi_info.displayType = MHL\n");
            }
            else if (hdmi_params->cabletype == MHL_3D_GLASSES)
            {
                hdmi_info.displayType = MHL_GLASSES;
                HDMI_LOG("mhl --- hdmi_info.displayType = MHL_GLASSES\n");
            }
            else
            {
                hdmi_info.displayType = HDMI;
                HDMI_LOG("mhl --- hdmi_info.displayType = HDMI\n");
            }
