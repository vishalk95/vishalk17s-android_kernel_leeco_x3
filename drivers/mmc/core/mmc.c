...
static int mmc_read_ext_csd(struct mmc_card *card, u8 *ext_csd)
{
	...
	card->ext_csd.raw_partition_support = ext_csd[EXT_CSD_PARTITION_SUPPORT];
    	...
    	card->ext_csd.ffu_capable= ext_csd[EXT_CSD_SUPPORTED_MODE];
        card->ext_csd.ffu_fw_config = ext_csd[EXT_CSD_FW_CONFIG];

        card->ext_csd.ffu_fw_version  = ext_csd [EXT_CSD_FW_VERSION] |
