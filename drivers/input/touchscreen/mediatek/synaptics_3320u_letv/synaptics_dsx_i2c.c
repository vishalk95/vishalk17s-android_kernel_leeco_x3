...
extern ssize_t (*synaptics_icon_differ_data_show)(struct device *dev, struct device_attribute *attr, char *buf);
...
static int synaptics_icon_differ_data_proc(struct file *file, char __user *page, size_t count, loff_t *ppos)
{
    char *ptr = page;
    ...
    ptr += synaptics_icon_differ_data_show(g_dev, NULL, ptr);
...
static PROC_FILE(icon_differ_data, S_IRUGO | S_IWUGO, synaptics_icon_differ_data_proc, synaptics_rmi4_store_error);
