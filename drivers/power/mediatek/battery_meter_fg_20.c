...
kal_int32 g_Q_MAX_POS_50[2] = {2806, 2806};
kal_int32 g_Q_MAX_POS_25[2] = {2850, 2850};
kal_int32 g_Q_MAX_POS_0[2] = {1829, 1829};
kal_int32 g_Q_MAX_NEG_10[2] = {940,940};

kal_int32 g_Q_MAX_POS_50_H_CURRENT[2] = {2750, 2750};
kal_int32 g_Q_MAX_POS_25_H_CURRENT[2] = {2792,2792};
kal_int32 g_Q_MAX_POS_0_H_CURRENT[2] = {1792, 1792};
kal_int32 g_Q_MAX_NEG_10_H_CURRENT[2] = {921, 921};

#else
kal_int32 g_Q_MAX_POS_50[2] = {2964, 2845};
kal_int32 g_Q_MAX_POS_25[2] = {2940, 2852};
kal_int32 g_Q_MAX_POS_0[2] = {2850, 2373};
kal_int32 g_Q_MAX_NEG_10[2] = {2947,561};
	
kal_int32 g_Q_MAX_POS_50_H_CURRENT[2] = {3094, 2788};
kal_int32 g_Q_MAX_POS_25_H_CURRENT[2] = {3053,2795};
kal_int32 g_Q_MAX_POS_0_H_CURRENT[2] = {2789, 2326};
kal_int32 g_Q_MAX_NEG_10_H_CURRENT[2] = {2141, 550};
#endif


//kal_int32 g_battery_id_voltage[2] = {2545, 14000};
kal_int32 g_battery_id_voltage[2] = {2600, 15000};
*/  //deli change:move to cust_battery_meter_table_multi_profile.h
...
/*[---by Rachel, support 2nd battery,20141208---]*/
...
void fgauge_get_profile_id(void)
{
	...
	id_volt = PMIC_IMM_GetOneChannelValue(ADC_ADCVIN0_AP, 1, 0);  /*[---Modify Rachel, support 2nd battery,20141208---]*/
...
kal_int32 get_dynamic_period(int first_use, int first_wakeup_time, int battery_capacity_level)
{
	...
	if (vbat_val > VBAT_NORMAL_WAKEUP)	/* 3.6v */
	{
		...
		//letv modify ALPS02306441 for sleep 30min
		if(ret_val < 1800)
			ret_val = 1800;
		//letv modfiy end
